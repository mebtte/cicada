...
const zhCN: {
  ...
  download: '导出',
  music_download_quality: '导出质量',
  music_download_quality_original: '原始文件',
  dashboard: '仪表盘',
  admin_panel: '管理后台',
  ...
  remove_download_item_question: '确定移除该导出项吗?',
  no_download: '暂无导出',
  download_status_total: '全部',
  download_status_active: '进行中',
  download_status_waiting: '等待中',
  download_status_downloading: '导出中',
  download_status_successful: '已完成',
  ...
  music_play_record_indefinite_retention_instruction:
    '1. 你的音乐播放记录将无限期保留, 更多信息请联系管理员。',
  music_play_record_days_retention_instruction:
    '1. 你的音乐播放记录将保留 %s1 天, 更多信息请联系管理员。',
  music_play_record_browser_limit_instruction:
    '2. 由于浏览器的限制, 有一定概率在某些极端情况下无法保留音乐播放记录。',
