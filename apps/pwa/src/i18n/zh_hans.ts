...
const zhCN: {
  ...
  music_import_running_warning: '正在上传音乐, 离开会暂停, 确定吗?',
  resume_draft_question: '选择对应的文件以继续上次未完成的上传',
  file_mismatch_warning: '所选文件与未完成的上传不匹配',
  asset_oversize_warning: '%s1 超过最大上传大小 %s2',
  remove: '移除',
  speed_per_second: '%s1/秒',
  pending_uploads: '待上传 %s1',
