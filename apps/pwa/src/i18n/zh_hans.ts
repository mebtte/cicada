...
const zhCN: {
  ...
  delete_singer: '删除歌手',
  delete_singer_question: '确定删除该歌手吗?',
  singer_has_music_can_not_be_deleted: '歌手关联了音乐, 无法被删除',
  delete_artist: '删除艺人',
  ...
  no_suitable_artist_warning: '找不到想要的艺人?',
  no_suitable_artist: '暂无相关艺人',
  create_artist: '创建艺人',
  repeated_name_artist_warning: '已有重名艺人, 是否重复创建?',
  create_artist_by_yourself: '自己创建艺人',
  created: '已创建',
  accept: '接受',
