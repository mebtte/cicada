...
unknown_singer: 'unknown singer',
  ...
  download: 'export',
  music_download_quality: 'export quality',
  music_download_quality_original: 'original file',
  dashboard: 'dashboard',
  ...
  remove_download_item_question:
    'are you sure to remove this export item ?',
  no_download: 'no exports',
  download_status_total: 'total',
  download_status_active: 'active',
  download_status_waiting: 'waiting',
  download_status_downloading: 'exporting',
  download_status_successful: 'done',
