export default {
  ...
  recent_artist: 'recently added artists',
  ...
  exploration_empty_description:
    'Import music with covers, add artist photos, or publish musicbills with covers. They will appear here as recommendations.',
  ...
  artist_has_music_can_not_be_deleted:
    'artist with linked music can not be deleted',
  ...
  no_suitable_artist_warning: 'no suitable artist ?',
  ...
  create_artist_by_yourself: 'create artist by yourself',
  created: 'created',
  accept: 'accept',
...
unknown_singer: 'unknown singer',
  ...
  singer_photo_total: 'singer photos',
  singer_without_photo: 'missing photo',
  artist_total: 'artist total',
  new_artist_7d: 'new in 7 days',
  artist_photo_total: 'artist photos',
  artist_without_photo: 'missing photo',
