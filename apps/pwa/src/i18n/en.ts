...
unknown_singer: 'unknown singer',
  ...
  music_import_running_warning:
    'a music upload is in progress, are you sure to leave?',
  resume_draft_question:
    'pick the matching file to resume your previous upload',
  file_mismatch_warning: 'selected file does not match the unfinished upload',
  asset_oversize_warning: '%s1 exceeds the upload limit %s2',
  remove: 'remove',
